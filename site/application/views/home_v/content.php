    ...
    <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
        <ul>
            ...
            <li data-index="rs-901"
                ...
                data-thumb="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide1-thumb.jpg"
                data-rotate="0"
                ...
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide1.jpg" alt=""
                     data-lazyload="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide1.jpg"
                ...
                <!-- LAYER NR. 5 [ for block] -->
                <div class="tp-caption  text-center tp-resizeme" id="slide-902-layer-4"
                    ...
                    Emniyetli, Ekonomik ve Estetik çözümler için iş ortağınız...
                </div>
            ...
            <li data-index="rs-902"
                ...
                data-thumb="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide2-thumb.jpg"
                ...
                data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide2.jpg" alt=""
                     data-lazyload="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide2.jpg"
                     data-bgposition="center center"
                     data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 [ for overlay ] -->
                ...
                <div class="tp-caption  text-center tp-resizeme"
                     ...
                     style="z-index: 13;
                                    ...
                                    color:#111;
                                    border-width:0px;font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                    <div>TEKNİK UYGULAMALARDA</div>

                </div>

                <!-- LAYER NR. 5 [ for block] -->

                <div class="tp-caption rev-btn text-center  tp-resizeme slider-block" id="slide-902-layer-3"
                ...
                <div class="tp-caption text-center  tp-resizeme" id="slide-902-layer-4"
                     ...
                     data-type="text"
                     data-responsive_offset="on"
                     data-frames='[{"delay":"+290","speed":1500,"sfxcolor":"#fff","sfx_effect":"blockfromleft","frame":"0","from":"z:0;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                     data-textAlign="['left','left','left','left']"
                     data-paddingtop="[5,5,5,5]"
                     data-paddingright="[0,0,0,0]"
                     data-paddingbottom="[0,0,0,0]"
                     ...
                     style="z-index: 13;
                         text-align: center;
                                    ...
                                    background: rgba(0,0,0,0.73);
                                    border-width:0px;font-family: 'Poppins', sans-serif;">
                    <p class="pl-2">Doğru çözümler ve güncel uygulama teknikleri.</p>

                </div>

                <!-- LAYER NR. 6 [ for see all service botton ] -->
                <div class="tp-caption text-center tp-resizeme" id="slide-902-layer-5"
                     data-x="['left','left','left','left']" data-hoffset="['50','130','130','130']"
                     data-y="['top','top','top','top']" data-voffset="['500','520','500','480']"
                     data-lineheight="['none','none','none','none']"
                     data-width="['300','300','300','300']"
            ...
            <li data-index="rs-903"
                ...
                data-easeout="default"
                data-masterspeed="default"
                data-thumb="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide3-thumb.jpg"
                data-rotate="0"
                data-fstransition="fade"
                data-fsmasterspeed="300"
                data-fsslotamount="7"
                ...
                data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide3.jpg" alt=""
                     data-lazyload="<?php echo base_url("assets"); ?>/images/main-slider/slider1/slide3.jpg"
                     data-bgposition="center center"
                     data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 [ for overlay ] -->
                ...
                <div class="tp-caption  text-center tp-resizeme" id="slide-902-layer-4"
                     ...
                     style="z-index: 13;
                                    ...
                                    background: rgba(0,0,0,0.73);
                                    border-width:0px;font-family: 'Poppins', sans-serif;">
                    Küçük detayları gözden kaçırmıyoruz.
