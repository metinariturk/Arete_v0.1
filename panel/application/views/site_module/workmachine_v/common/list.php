                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="<?php echo $main_category->id; ?>" action="<?php echo base_url("$this->Module_Name/add_sub"); ?>"
                                          url="<?php echo base_url("$this->Module_Name/add_sub"); ?>" autocomplete="off"
                                          method="post" enctype="multipart">
                                        <div class="mb-3">
                                            <label class="col-form-label" for="recipient-name">Ana İş Makinesi Grubu:</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="col-form-label" for="message-text">İş Makinesi Adı</label>
