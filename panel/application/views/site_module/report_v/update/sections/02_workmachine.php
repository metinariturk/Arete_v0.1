    ...
    <div class="repeater">
        ...
        <div data-repeater-list="workmachines" class="mb-3 border rounded p-3">
            <?php if (!empty($workmachines)) { ?>
                <?php foreach ($workmachines as $workmachine_return) { ?>
                    <div data-repeater-item>
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-md-2 mb-2">
                                <select class="form-control" name="workmachine">
                                    <option value="">İş Makinesi Seçiniz</option>
                                    <?php foreach ($active_machines as $active_machine_group => $workmachine_inner) {
                                        foreach ($workmachine_inner as $machine) { ?>
