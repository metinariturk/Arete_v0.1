                    ...
                    <div class="card-footer row">
                        <div class="col-6 col-sm-6">
                            ...
                            <h5><span class="counter">
                                <?php echo money_format($total_expense); ?>
                            </span>TL</h5>
                        </div>
                        <div class="col-6 col-sm-6">
                            <h6>Avans</h6>
                            <h5><span class="counter">
                                <?php echo money_format($total_deposit); ?>
                            </span>TL</h5>
                        </div>
                    </div>
                    <hr>
                    <div class="text-center profile-details">
                        <h5 class="counter"><?php echo money_format($total_deposit - $total_expense); ?><?php $contract->para_birimi; ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-4 box-col-6">
