<div class="mb-2">
    <div class="col-form-label">Hatırlatma Tarihi Düzenleme</div>
...
<div class="mb-2">
    <input class="form-control <?php cms_isset(form_error("title"), "is-invalid", ""); ?>"
           ...
           placeholder="Başlık"
           value="<?php echo isset($form_error) ? set_value("title") : $edit_note->title; ?>"/>
    <?php if (isset($form_error)) { ?>
...
<div class="mb-2">
    <input class="form-control <?php cms_isset(form_error("topic"), "is-invalid", ""); ?>"
           ...
           placeholder="Konu"
           value="<?php echo isset($form_error) ? set_value("topic") : $edit_note->topic; ?>"/>
    <?php if (isset($form_error)) { ?>
...
<div class="mb-2">
    <input class="form-control <?php cms_isset(form_error("note"), "is-invalid", ""); ?>"
           name="note" type="text"
           placeholder="Not"
           value="<?php echo isset($form_error) ? set_value("note") : $edit_note->note; ?>"/>
    <?php if (isset($form_error)) { ?>
