...
<?php } else { ?>
    <?php $a = $this->Dependet_id_key; $delete_all_id = $item_files[0]->$a; ?>
    <?php if ($subViewFolder=="update") { $from = "update_form"; } elseif ($subViewFolder=="display") { $from = "file_form";} ?>
        ...
        <?php foreach ($item_files as $file) { ?>
            <tr id="ord-<?php echo $file->id; ?>">
                ...
                <td class="w15">
                    ...
                    <a onclick="deleteConfirmationFile(this)" data-text="Bu Dosyayı" data-url="<?php echo base_url("$this->Module_Name/fileDelete/$file->id/file_form"); ?>">
