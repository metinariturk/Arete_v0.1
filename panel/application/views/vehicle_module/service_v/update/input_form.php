...
<div class="row">
    ...
    <div class="col-sm-2">
        ...
        <select name="gerekce" class="form-control" data-plugin="select2">
            <option selected value="<?php echo isset($form_error) ? set_value("gerekce") : $item->gerekce; ?>"><?php echo isset($form_error) ? servis_gerekce(set_value("gerekce")) : servis_gerekce($item->gerekce); ?></option>
    ...
    <div class="col-sm-2">
        ...
        <input type="text" id="datetimepicker" class="form-control"
               name="servis_tarih"
               value="<?php echo isset($form_error) ? set_value("servis_tarih") : dateFormat('d-m-Y',$item->servis_tarih); ?>"
    ...
    <div class="col-sm-2">
        ...
        <input type="text" class="form-control"
               ...
               value="<?php echo isset($form_error) ? set_value("servis_km_saat") : $item->servis_km_saat; ?>">
        <?php if (isset($form_error)) { ?>
    ...
    <div class="col-sm-2">
        ...
        <select name="islem_turu" class="form-control" data-plugin="select2">
            <option value="<?php echo isset($form_error) ? set_value("islem_turu") : $item->islem_turu; ?>"><?php echo isset($form_error) ? islem_turu(set_value("islem_turu")) : islem_turu($item->islem_turu); ?></option>
...
<div class="row">
    <div class="col-sm-2">
        ...
        <select name="servis_firma" class="form-control" data-plugin="select2">
            <option value="<?php echo isset($form_error) ? set_value("servis_firma") : $item->servis_firma; ?>"><?php echo isset($form_error) ? company_name(set_value("servis_firma")) : company_name($item->servis_firma); ?></option>
    ...
    <div class="col-sm-4">
        ...
        <textarea class="form-control" id="textarea1" name="genel_bilgi" placeholder="Açıklama"><?php echo isset($form_error) ? set_value("genel_bilgi") : $item->genel_bilgi; ?></textarea>
        <?php if (isset($form_error)) { ?>
