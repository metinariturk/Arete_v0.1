<div class="card-body">
    <div class="mb-2">
        <div class="row">
            <div class="col-12">
                <div class="col-form-label fw-bold">&nbsp;</div>
    ...
    <form id="update_user" method="post" data-form-url="<?php echo base_url("User/update/$item->id"); ?>"
          enctype="multipart/form-data" autocomplete="off">

        <div class="mb-2">
            <div class="col-form-label fw-bold">Ad</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Soyad</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Meslek</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Ünvan</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Giriş Tarihi</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Telefon</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Kullanıcı Adı</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">E-Posta</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Sistem Kullanıcısı</div>
            <div class="form-check">
                ...
                <label class="form-check-label" for="user_role">
                    Personelin sistemi kullanması için onay ver
                </label>
                <p class="text-warning">Lütfen daha sonrasında personel kullanım izni ayarlarını yapınız</p>
            </div>
            <?php if (isset($form_error)) { ?>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Şifre Değiştir</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Yeni Şifre Tekrar</div>
        ...
        <div class="mb-2">
            <div class="col-form-label fw-bold">Banka</div>
        ...
        <div class="mb-3">
            <label class="col-form-label fw-bold" for="IBAN">IBAN:</label>
