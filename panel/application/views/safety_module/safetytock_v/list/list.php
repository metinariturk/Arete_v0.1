    ...
    <?php if (empty($items)) { ?>
        <div class="alert alert-info text-center">
            <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen
                <a href="<?php echo base_url("sitestock/select"); ?>"> Buradan Yeni Teknik Yaklaşık Maliyet Ekleyiniz</a>
            </p>
        </div>
    <?php } else { ?>
        ...
        <table id="default-datatable" data-plugin="DataTable" class="table table-striped">
            ...
            <?php foreach ($items as $item) { ?>
                <tr>
                    ...
                    <td class="w10"></td>
                    <td class="w10">
                        <a class="btn btn-info pager-btn" href="<?php echo base_url("sitestock/file_form/$item->id"); ?>"
