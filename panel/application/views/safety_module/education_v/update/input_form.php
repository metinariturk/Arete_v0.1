        ...
        <td>
            <select id="select2-demo-1" style="width: 100%;" class="form-control"
                ...
                <option selected="selected"
                        value="<?php echo isset($form_error) ? set_value("egitim_turu") : "$item->egitim_turu"; ?>"><?php echo isset($form_error) ? set_value("egitim_turu") : "$item->egitim_turu"; ?>
                </option>
    ...
    <tr>
        ...
        <td>
            <input type="text" id="datetimepicker"
                   class="form-control"
                   name="egitim_tarihi"
                   value="<?php echo isset($form_error) ? set_value("egitim_tarihi") : dateFormat_dmy($item->egitim_tarihi); ?>"
    ...
    <tr>
        ...
        <td>
            <input type="text" id="datetimepicker"
                   ...
                   value="<?php echo isset($form_error) ? set_value("gecerlilik_tarihi") : dateFormat_dmy($item->gecerlilik_tarihi); ?>"
                   data-plugin="datetimepicker" data-options="{ format: 'DD-MM-YYYY' }">
            <?php if (isset($form_error)) { ?>
    ...
    <tr>
        ...
        <td>
            <select id="select2-demo-1" style="width: 100%;" class="form-control"
                ...
                <option selected="selected"
                        value="<?php echo isset($form_error) ? set_value("egitim_veren") : $item->egitim_veren; ?>"><?php echo isset($form_error) ? full_name(set_value("egitim_veren")) : full_name($item->egitim_veren); ?></option>
