<form id="add_main"
    ...
    <div class="card-body">
        <div class="mb-2">
            ...
            <input step="any" class="form-control <?php cms_isset(form_error("main_group_code"), "is-invalid", ""); ?>"
            ...
            <?php } ?>
            <input step="any" class="form-control <?php cms_isset(form_error("group_name"), "is-invalid", ""); ?>"
