    ...
    <div class="row">
        <div class="form-group col-sm-12">
            ...
            <?php if (isset($form_error)) { ?>
                <small class="pull-right input-form-error"><?php echo form_error("sirket_adi"); ?></small>
            <?php } ?>
        </div>
        <div class="row">
            <div class="form-group col-sm-12">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <input class="form-control" placeholder="Vergi No"
                       name="vergi_no"
                       value="<?php echo isset($form_error) ? set_value("vergi_no") : str_pad($item->vergi_no, 10, "0", STR_PAD_LEFT);
                       ?>">
                <?php if (isset($form_error)) { ?>
                    <small
                            class="pull-right input-form-error"> <?php echo form_error("vergi_no"); ?></small>
                <?php } ?>
            </div>
            <div class="form-group col-sm-6">
                ...
                <?php if (isset($form_error)) { ?>
                    <small
                            class="pull-right input-form-error"> <?php echo form_error("vergi_daire"); ?></small>
                <?php } ?>
            </div>
        </div><!-- Vergi no / Daire -->
        <div class="row">
