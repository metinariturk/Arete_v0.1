                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="auction_id"
                                                ...
                                                <div class="mb-3">
                                                    <label class="col-form-label" for="recipient-name">Şartname Türü Seçiniz</label>
                                                    <select style="width: 100%" id="select2-demo-1" class="form-control"
                                                            data-plugin="select2" name="condition_type">
                                                        <option value="<?php echo isset($form_error) ? set_value("condition_type") : ""; ?>"><?php echo isset($form_error) ? condition_type(set_value("condition_type")) : "Seçiniz"; ?></option>
                                                        <option value="1"><?php echo condition_type(1); ?></option>
                                                        <option value="2"><?php echo condition_type(2); ?></option>
                                                        <option value="3"><?php echo condition_type(3); ?></option>
                                                    </select>
                                                </div>
                                            </form>
                                        </div>
