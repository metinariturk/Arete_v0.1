...
<div class="col-md-12 col-xl-4">
    <div class="card">
        <div class="card-body">
            <div class="mb-2">
                <div class="col-form-label">İhale Kodu</div>
                <div class="input-group"><span class="input-group-text" id="inputGroupPrepend">IHL</span>
                    ...
                    <?php if (isset($form_error)) { ?>
                        ...
                        <div class="invalid-feedback">* Önerilen Proje Kodu
                            : <?php echo increase_code_suffix("auction"); ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
            <div class="mb-2">
                ...
                <input type="text"
                       ...
                       value="<?php echo isset($form_error) ? set_value("ihale_ad") : ""; ?>" name="ihale_ad">
                <?php if (isset($form_error)) { ?>
                    ...
                    <div class="col-3">
                        ...
                        <select id="select2-demo-1" style="width: 100%;" class="form-control" data-plugin="select2"
                            ...
                            <option selected="selected"
                                    value="<?php echo isset($form_error) ? set_value("para_birimi") : "TL"; ?>">
                                <?php echo isset($form_error) ? set_value("para_birimi") : "TL"; ?>
                            </option>
                            <?php
        ...
        <div class="card-body">
            ...
            <div class="mb-2">
                ...
                <input type="text"
                       ...
                       placeholder="İhale Genel Notları"
                       value="<?php echo isset($form_error) ? set_value("aciklama") : ""; ?>"
                       name="aciklama">
                <?php if (isset($form_error)) { ?>
