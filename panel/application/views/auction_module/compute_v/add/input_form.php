...
<div class="card">
    <div class="card-body">
        <div class="mb-2">
            ...
            <div class="input-group"><span class="input-group-text" id="inputGroupPrepend">MET</span>
                <?php if (!empty(get_last_fn("compute"))) { ?>
                    <input class="form-control <?php cms_isset(form_error("dosya_no"), "is-invalid", ""); ?>"
                           ...
                           value="<?php echo isset($form_error) ? set_value("dosya_no") : increase_code_suffix("compute"); ?>">
                    <?php
                } else { ?>
                    <input class="form-control <?php cms_isset(form_error("dosya_no"), "is-invalid", ""); ?>"
                ...
                <?php if (isset($form_error)) { ?>
                    ...
                    <div class="invalid-feedback">* Önerilen Proje Kodu
                        : <?php echo increase_code_suffix("compute"); ?>
                    </div>
                <?php } ?>
            </div>
        </div>
        <div class="mb-2">
            ...
            <select id="select2-demo-1"
                    ...
                    data-plugin="select2"
                    name="metraj_grup">
                <option value="<?php echo isset($form_error) ? set_value("metraj_grup") : ""; ?>"><?php echo isset($form_error) ? set_value("metraj_grup") : ""; ?></option>
                <?php
        ...
        <div class="mb-2">
            ...
            <input class="form-control <?php cms_isset(form_error("metraj_ad"), "is-invalid", ""); ?>"
                   ...
                   name="metraj_ad"
                   value="<?php echo isset($form_error) ? set_value("metraj_ad") : ""; ?>"/>
            <?php if (isset($form_error)) { ?>
