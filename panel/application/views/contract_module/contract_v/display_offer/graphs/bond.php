        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div>
                    ...
                    <ul>
                        <li class="m-2"><b>Toplam Teminat</b><br><i>
                                <?php $total_contract = sum_anything_and_or("bond", "teminat_miktar", "contract_id", "$item->id","teminat_gerekce","contract","price_diff");
