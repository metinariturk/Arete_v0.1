    ...
    <div class="card-header">
        <div class="media">
            <div class="media-body text-end">
                <i class="fa fa-plus-square fa-2x" data-bs-toggle="modal"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="newFolderModalLabel">Yeni Klasör
                                    Oluştur</h5>
                            ...
                            <div class="modal-body">
                                <form id="newFolderForm">
                                    <input class="form-control" id="folderName" name="folderName"
                                           data-item-id="<?= $item->id ?>"
                                           placeholder="Klasör adını girin"
                                           required>
                                    <button type="submit" class="btn btn-primary">Klasör Oluştur
                                    </button>
                                </form>
                            </div>
                        </div>
