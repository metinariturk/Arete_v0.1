                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-sm">
                                ...
                                foreach ($sub_groups as $sub_group) {
                                    ...
                                    <tr>
                                        <td style="width: 15%;">
                                            <b><?php echo $prices_main_group->code . '.' . $sub_group->code; ?></b></td>
                                        ...
                                        <td style=" width: 40%; text-align: center;" colspan="2">
                                            <a data-bs-toggle="modal" class="text-success"
                                               id="open_edit_pricegroup_modal_<?php echo $sub_group->id; ?>"
                                               onclick="edit_modal_form('<?php echo base_url("Contract/open_edit_pricegroup_modal/$sub_group->id"); ?>','edit_pricegroup_modal','EditPricegroupModal')">
