            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editContractForm"
                        ...
                        <div id="edit_Contract_modal">
                            <?php $this->load->view("{$viewModule}/{$viewFolder}/{$subViewFolder}/modals/edit_contract_form_input"); ?>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                            ...
                            onclick="submit_modal_form('editContractForm', 'EditContractModal', 'edit_Contract_modal')">
                        Gönder
                    </button>
                </div>
            </div>
