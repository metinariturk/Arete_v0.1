            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editContractForm"
                          data-form-url="<?php echo base_url("$this->Module_Name/edit_contract/$edit_item->id"); ?>"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                            ...
                            onclick="submit_modal_form('editContractForm', 'EditContractModal', 'tab_Contract')">
                        Gönder
                    </button>
                </div>
            </div>
...
<?php if (isset($edit_item)) { ?>
    <?php if (isset($error_modal) && $error_modal == "EditContractModal") { ?>
        <script>
            // Eski backdrop varsa kaldır
            $('.modal-backdrop').remove();
            // Modal open class'ını kaldır
            $('body').removeClass('modal-open');
            // Body'nin overflow stilini geri al
            $('body').css('overflow', 'auto');
            // EditContractModal'ı göster
