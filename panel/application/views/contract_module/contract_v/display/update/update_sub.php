<div>
    <a  style="cursor: pointer;"  data-bs-toggle="modal" data-bs-target="#updateFormModal" data-whatever="@getbootstrap"><i class="fa fa-edit fa-2x"></i> Proje Düzenle</a>
    <div class="modal fade" id="updateFormModal" tabindex="-1" role="dialog" aria-labelledby="updateFormModal" aria-hidden="true">
                        ...
                        <form class="row g-3 needs-validation" novalidate="" action="<?php echo base_url("$this->Module_Name/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                            <div class="card-header">
                                <div class="mb-2">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="col-form-label">Alt Sözleşme Ad</div>
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroupPrepend"><?php echo $item->dosya_no; ?></span>
