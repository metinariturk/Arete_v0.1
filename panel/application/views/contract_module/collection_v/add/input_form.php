            ...
            <div class="col-form-label">Tahsilat Tutar
                <?php if (isset($form_error)) { ?>
                    <?php if (!empty(form_error("tahsilat_miktar"))) { ?>
                        <div style="color: red">*** Sözleşme bedelinden fazla tahsilat yapılamaz. Özel bir gerekçe ile
                            fazla tahsilat yapılmas gerekiyorsa aşağıdaki onay kutusunu işaretleyiniz.
                            <br><input name="onay" type="checkbox" id="cb-10"> Sözleşme bedelinden fazla tahsilat yapmak
                            istiyorum!
                        </div>
                    <?php } ?>
                <?php } ?>
