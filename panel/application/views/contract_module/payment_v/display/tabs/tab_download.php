            ...
            <div class="col-md-4">
                <form name="print_all" method="post" target="_blank">
                    <div class="col-md-12">
                        <div class="h-100 checkbox-checked">
                            <h6>
                                ...
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="contract_report" style="margin-left: 20px" checked
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                <label class="form-check-label" for="checkbox-primary2">01 - Hakediş Raporu
                                    (Kapak)</label>
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="report_cover" style="margin-left: 20px" checked
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                <label class="form-check-label" for="checkbox-primary3">02 - Hakediş Raporu (Hesap
                                    Cetveli)</label>
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="report_calculate" style="margin-left: 20px" checked
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                <label class="form-check-label" for="checkbox-primary4">03 - Yapılan İşler Genel
                                    İcmal</label>
                                <div class="form-check checkbox checkbox-success mb-0">
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                ...
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="wd_hide_zero" style="margin-left: 20px" checked id="checkbox-primary6" type="checkbox" onchange="toggleCheckbox(this)">
                                    <label class="form-check-label" for="checkbox-primary6">Sıfır Olanları Gizle</label>
                                </div>
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="wd_all" style="margin-left: 20px" id="checkbox-primary7" type="checkbox" onchange="toggleCheckbox(this)">
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                ...
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="green_hide_zero" style="margin-left: 20px" id="checkbox-primary8" checked
                                           type="checkbox">
                        ...
                        <div class="h-100 checkbox-checked">
                            <h6>
                                ...
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="all_calculate" style="margin-left: 20px" checked
                                           id="checkbox-primary10" type="checkbox">
                                    <label class="form-check-label" for="checkbox-primary10">Tüm Metrajlar</label>
                                </div>
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="calculate_seperate_main" style="margin-left: 20px" id="checkbox-primary11"
                                           type="checkbox">
                                    <label class="form-check-label" for="checkbox-primary11">Ana Gruplardan Ayır</label>
                                </div>
                                <div class="form-check checkbox checkbox-success mb-0">
                                    <input class="form-check-input" name="calculate_seperate_sub" style="margin-left: 20px" id="checkbox-primary12"
                                           type="checkbox">
