                ...
                <form id="save_payment"
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit"
                                        class="btn btn-success btn-block"  type="submit"   id="submit_button"   onclick="calcular()" style="text-align: right">
        ...
        <?php } else { ?>
            <div class="col-sm-8 offset-sm-2 offset-2" style="overflow-x: auto; white-space: nowrap;">
                <form id="save_payment"
                    ...
                    <button type="submit"
                            class="btn btn-danger btn-block" style="text-align: right">
