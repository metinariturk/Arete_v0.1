    ...
    <div class="col-sm-10 offset-1">
        ...
        <?php foreach ($active_boqs as $group_key => $boq_ids) { ?>
            <table>
                ...
                <tr style="height:14.1pt;">
                    <td
                            style="width:3%; text-align: center;  border: 0.75pt solid black; border-width:0.75pt;">
                        <p><strong> # </strong></p>
                    </td>
                    <td
                            style="width:9%; text-align: center; border: 0.75pt solid black; border-width:0.75pt;">
                        <p><strong><?php echo $group_key; ?></strong></p>
                    </td>
                    <td
                            style="width:25%; text-align: center; border: 0.75pt solid black; border-width:0.75pt;">
                        <p><strong><?php echo boq_name($group_key); ?></strong></p>
                    </td>
                    <td
                            style="width:4%; text-align: center; border: 0.75pt solid black; border-width:0.75pt;">
                        <p><strong><?php echo money_format($all_time); ?></strong></p>
                    </td>
                    <td style="width:8%; text-align: center; border: 0.75pt solid black; border-width:0.75pt;">
