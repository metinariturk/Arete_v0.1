    ...
    <div class="card-body">
        ...
        <div class="mb-2">
            ...
            <input class="datepicker-here form-control digits <?php cms_isset(form_error("baslangic_tarih"), "is-invalid", ""); ?>"
                   ...
                   value="<?php echo isset($form_error) ? set_value("baslangic_tarih") : dateFormat_dmy($item->baslangic_tarih); ?>"
                   data-options="{ format: 'DD-MM-YYYY' }"
                   data-language="tr">
            <?php if (isset($form_error)) { ?>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="mb-2">
                    ...
                    <span>Keşif Artışı</span>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="mb-2">
                    <div class="col-form-label">Sözleşmeye Göre Bitiş Tarihi</div>
            ...
            <div class="col-sm-4">
                <div class="mb-2">
                    ...
                    <a href="<?php echo base_url("costinc/file_form/$item->costinc_id"); ?>" target="_blank">
                        <?php echo dateFormat_dmy(get_from_id("costinc", "artis_tarih", "$item->costinc_id")); ?>
                    </a>
                </div><!--Açıklama-->
            </div>
        </div>
