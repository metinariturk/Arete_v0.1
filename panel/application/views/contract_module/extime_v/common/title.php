...
<?php } elseif ($subViewFolder == "add_costinc") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <?php if (!empty($contract_id)) { ?>
                                <button type="submit" form="save_costinc" class="btn btn-success">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="update_contract"
...
<?php } elseif ($subViewFolder == "update_costinc") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="update_costinc"
                                    class="btn btn-success">
                                <i class="fa fa-floppy-o fa-lg"></i> Kaydet
                            </button>
                        </li>
        ...
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            <?php $last_decision = dateFormat_dmy(get_last_date($item->contract_id, "extime", "karar_tarih"));
                            $difference = date_minus($item->karar_tarih, $last_decision); ?>
                            <?php if ($difference >= 0) { ?>
                            ...
                            <?php } elseif ($difference <= 0) { ?>
                                <button class="btn btn-success" type="button" onclick="disabled_module(this)"
                                        data-text="*Sadece Son Girilen Süre Uzatımı Evrakında Düzenleme Yapabilirsiniz"
                                        data-note="Bu İşlemi Gerçekleştirmezsiniz">
                                <i class="menu-icon fa fa-edit fa-lg"></i> Düzenle
                                </button>
                            <?php } ?>
