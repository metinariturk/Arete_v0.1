...
<?php } elseif ($subViewFolder == "add_newprice") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <?php if (!empty($contract_id)) { ?>
                                <button type="submit" form="save_newprice" class="btn btn-success">
...
<?php } elseif ($subViewFolder == "update_newprice") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="update_newprice"
