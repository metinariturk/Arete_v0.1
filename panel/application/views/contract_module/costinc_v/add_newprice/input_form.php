<?php $ybf_tutar = get_from_any("newprice", "ybf_tutar", "id", "$newprice_id"); ?>
<div class="card">
    <div class="card-body">
        <div class="mb-2">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input class="datepicker-here form-control digits <?php cms_isset(form_error("artis_tarih"), "is-invalid", ""); ?>"
                           type="text"
                           name="artis_tarih"
                           value="<?php echo isset($form_error) ? set_value("artis_tarih") : ""; ?>"
        ...
        <div class="mb-2">
            ...
            <input type="text" id="calA" onblur="calcular()" onfocus="calcular()"
                   ...
                   value="<?php echo isset($form_error) ? set_value("artis_miktar") : "$ybf_tutar"; ?>">
        ...
        <div class="mb-2">
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    <div class="col-form-label">YBF Dosya No</div>
                    <div>
                        <?php echo get_from_any("newprice", "dosya_no", "id", "$newprice_id"); ?></span>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3">
                ...
                <div class="col-sm-4 col-md-3">
                    <div class="col-form-label">YBF Tutar</div>
                    <div>
                        <?php
                        echo money_format($ybf_tutar) . " " . get_currency($contract_id);
                        ?>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3">
                    <div class="col-form-label">YBF/Sözleşme Oranı</div>
                    <div>
                        % <?php echo get_from_any("newprice", "ybf_oran", "id", "$newprice_id"); ?>
                    </div>
                </div>
            </div>
        </div><!--Kapalı Bilgi-->
        <div class="mb-2">
            <?php if (isset($form_error)) { ?>
                <?php if (set_value("artis_oran") >= 20) { ?>
                ...
                <?php } ?>
            <?php } ?>
            <div class="col-form-label">Keşif Artışı/Sözleşme Oranı <?php echo $onay_input; ?></div>

            <input hidden type="text" id="calD"
                   value="<?php echo isset($form_error) ? set_value("artis_oran") : ""; ?>"
                   name="artis_oran">
            <div class="col-sm-4">
                %
                <span id="calC" onblur="calcular()" <?php if (!empty(form_error("artis_oran"))) { ?>
                    class="text-danger";
                <?php } ?>
                              onfocus="calcular()"> <?php echo isset($form_error) ? set_value("artis_oran") : ""; ?></span>
            </div>
            <?php if (isset($form_error)) { ?>
