<?php $ybf_tutar = get_from_any("newprice", "ybf_tutar", "id", "$item->newprice_id"); ?>
<div class="card">
    <div class="card-body">
        <div class="mb-2">
        ...
        <div class="mb-2">
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    ...
                    <div>
                        <?php echo get_from_any("newprice", "dosya_no", "id", "$item->newprice_id"); ?></span>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3">
                ...
                <div class="col-sm-4 col-md-3">
                    ...
                    <div>
                        % <?php echo get_from_any("newprice", "ybf_oran", "id", "$item->newprice_id"); ?>
                    </div>
                </div>
            </div>
        </div><!--Kapalı Bilgi-->
