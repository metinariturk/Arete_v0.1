        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            ...
                            <select id="select2-demo-1" style="width: 100%;"
                                ...
                                <option selected
                                        value="<?php echo $item->gecici_kabul_kesinti; ?>"><?php echo var_yok_name($item->gecici_kabul_kesinti); ?>
                                </option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-2">
                            ...
                            <select id="select2-demo-1" style="width: 100%;"
                                ...
                                <option selected
                                        value="<?php echo $item->fiyat_fark; ?>"><?php echo var_yok_name($item->fiyat_fark); ?>
                                </option>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <div class="col-form-label">Fiyat Farkı Teminatının Hakedişten Düşülmesi</div>
                            <select id="select2-demo-1" style="width: 100%;"
                                    class="form-control <?php cms_isset(form_error("fiyat_fark_teminat"), "is-invalid", ""); ?>"
                                    data-plugin="select2" name="fiyat_fark_teminat">
                                <option selected
                                        value="<?php echo $item->fiyat_fark_teminat; ?>"><?php echo var_yok_name($item->fiyat_fark_teminat); ?>
                                </option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <div class="col-form-label">Hakedişte Damga Vergisi
                                Kesintisi<?php set_value("damga_oran"); ?></div>
                            <select id="select2-demo-1" style="width: 100%;"
                                    class="form-control <?php cms_isset(form_error("damga_kesinti"), "is-invalid", ""); ?>"
                                    data-plugin="select2" name="damga_kesinti">
                                <option selected
                                        value="<?php echo $item->damga_kesinti; ?>"><?php echo var_yok_name($item->damga_kesinti); ?>
                                </option>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <div class="col-form-label">İhzarat</div>
                            <select id="select2-demo-1" style="width: 100%;"
                                    class="form-control <?php cms_isset(form_error("ihzarat"), "is-invalid", ""); ?>"
                                    data-plugin="select2" name="ihzarat">
                                <option selected
                                        value="<?php echo $item->ihzarat; ?>"><?php echo var_yok_name($item->ihzarat); ?>
                                </option>
