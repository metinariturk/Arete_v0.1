<?php if (empty($final_files)) { ?>
    <hr>
    <div class="final_list_container">
        ...
        <div class="content-container">
            <table class="table table-bordered table-striped table-hover pictures_list">
                ...
                <tr>
                    ...
                    <th>Dosya Adı</th>
                    <th>
                        <a href="<?php echo base_url("$this->Module_Name/download_all/$item->id/final"); ?>">
                            <i style="font-size: 18px;" class="fa fa-arrow-circle-down" aria-hidden="true"></i>
                        </a>
                    </th>
                    <th>
                        <a onclick="finaldeleteConfirmationFile(this)"
                           url="<?php echo base_url("$this->Module_Name/fileDelete_all_final/$delete_all_id"); ?>"
                ...
                <?php foreach ($final_files as $file) { ?>
                    <tr id="ord-<?php echo $file->id; ?>">
                        ...
                        <td class="w15">
                            <a href="<?php echo base_url("$this->Module_Name/file_download/$file->id/final"); ?>">
                                <i style="font-size: 18px;" class="fa fa-arrow-circle-down" aria-hidden="true"></i>
                            </a>
                        </td>
                        <td>
                            <a onclick="finaldeleteConfirmationFile(this)"
                               url="<?php echo base_url("$this->Module_Name/finalfileDelete/$file->id"); ?>"
