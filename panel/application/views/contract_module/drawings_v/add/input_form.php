    ...
    <div class="card-body">
        ...
        <div class="mb-2">
            ...
            <select style="width: 100%" id="select2-demo-1"
                ...
                <option value="<?php echo isset($form_error) ? set_value("cizim_grup") : ""; ?>"><?php echo isset($form_error) ? set_value("cizim_grup") : ""; ?></option>
                <?php
        ...
        <div class="mb-2">
            ...
            <select id="select2-demo-1"
                ...
                <option value="<?php echo isset($form_error) ? set_value("onay") : ""; ?>"><?php echo isset($form_error) ? full_name(set_value("onay")) : ""; ?></option>
