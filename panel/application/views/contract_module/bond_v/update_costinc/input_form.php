    ...
    <div class="card-body">
        ...
        <div class="mb-2">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-3">
                    <div class="col-form-label">Keşif Artış Tutarı</div>
                    <div>
                        <input hidden id="calB" onblur="calcular()" onfocus="calcular()"
                               onChange="myFunction(calB)"
                               name="artis_miktar"
                               value="<?php echo get_from_id("costinc", "artis_miktar", $item->teminat_kesif_id); ?>"/>
                        <span><?php echo money_format(get_from_id("costinc", "artis_miktar", $item->teminat_kesif_id)) . " " . get_currency($contract_id); ?></span>
                    </div>
                </div>
                <div class="col-sm-4 col-md-3">
