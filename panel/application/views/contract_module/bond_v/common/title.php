...
<?php } elseif ($subViewFolder == "add_advance") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="save_advance" class="btn btn-success">
...
<?php } elseif ($subViewFolder == "update_advance") { ?>
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="update_bond_advance"
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <button type="submit" form="update_bond_costinc"
                                    class="btn btn-success">
                                <i class="fa fa-floppy-o fa-lg"></i> Kaydet
                            </button>
                        </li>
