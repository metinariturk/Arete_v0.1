                        ...
                        <div class="col-sm-4 col-md-3">
                            ...
                            <div>
                                <input hidden id="calB" onblur="calcular()" onfocus="calcular()"
                                       ...
                                       name="avans_miktar"
                                       value="<?php echo get_from_id("advance", "avans_miktar", $advance_id); ?>"/>
                                <span><?php echo money_format(get_from_id("advance", "avans_miktar", $advance_id)) . " " . get_currency($contract_id); ?></span>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-3">
