        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-form-label">
                    <input type="checkbox" name="fiyat_fark" <?php if ($item->teminat_gerekce == "price_diff") {echo "checked"; } ?>/>
                ...
                <div class="mb-2">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3">
                            <div class="col-form-label">Teminata Ait Sözleşmeın Tutarı</div>
                            <div>
                                <input hidden id="calB" onblur="calcular()" onfocus="calcular()"
                                       onChange="myFunction(calB)"
                                       name="avans_miktar"
                                       value="<?php echo get_from_id("contract", "sozlesme_bedel", $item->contract_id); ?>"/>
                                <span><?php echo money_format(get_from_id("contract", "sozlesme_bedel", $item->contract_id)) . " " . get_currency($contract_id); ?></span>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-3">
                            <div class="col-form-label">Teminatın Sözleşmea Oranı</div>
