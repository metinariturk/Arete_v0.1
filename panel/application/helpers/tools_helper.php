...
function get_city_coordinates_from_accuweather($city)
{
    $api_key = 'hJA0Edlt4yr3aaQTe2V2b0i43R3A5LX5';  // Your API key here
    $url = "http://dataservice.accuweather.com/locations/v1/cities/search?q=" . urlencode($city) . "&apikey=$api_key";
