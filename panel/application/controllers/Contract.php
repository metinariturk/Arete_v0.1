...
class Contract extends CI_Controller
{
    ...
    public function file_form($id, $active_tab = null, $error = null)
    {
        ...
        if ($type == 1) {
            ...
            if ($active_tab == "workplan" and (isset($error))) {
            ...
            } elseif ($active_tab == "sitedel" and (isset($error))) {
                $viewData->error = "Yer Teslimi Tarihi, Sözleşme Tarihinden Önce Olamaz";
            } elseif ($active_tab == "provision" and (isset($error))) {
            ...
            if ($validate) {
                ...
                $insert = $this->Contract_model->add(
                    array(
                        ...
                        "damga_kesinti" => $payments->damga_kesinti,
                        "stopaj_oran" => $payments->stopaj_oran,
                        "avans_durum" => $payments->avans_durum,
                        "avans_mahsup_durum" => $payments->avans_mahsup_durum,
                        "avans_mahsup_oran" => $payments->avans_mahsup_oran,
                        "avans_stopaj" => $payments->avans_stopaj,
                        "ihzarat" => $payments->ihzarat,
                        "fiyat_fark" => $payments->fiyat_fark,
                        "fiyat_fark_teminat" => $payments->fiyat_fark_teminat,
                        "teminat_oran" => $payments->teminat_oran,
                        "gecici_kabul_kesinti" => $payments->gecici_kabul_kesinti,
                        "durumu" => "1",
    ...
    public function update_payment($id)
    {
        ...
        if (($this->input->post('damga_oran')) > 0) {
        ...
        if ($validate) {
            ...
            $this->session->set_flashdata("alert", $alert);
            redirect(base_url("$this->Module_Name/$this->Display_route/$id/payment"));
