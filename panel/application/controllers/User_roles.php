...
class User_roles extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->Module_Name = "user_roles";
        $this->Module_Title = "Kullanıcı Yetkileri";
    ...
    public function permissions_form($id){
        ...
        $permissions = json_decode(get_from_id("user_roles","permissions","$id"));
    ...
    public function update_permissions($id){
        ...
        // Update Süreci...
        $update_personel = $this->User_model->update(
            array("user_role_id" => $id),
            array(
